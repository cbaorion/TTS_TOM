...
from tom_observations.facility import GenericObservationForm, GenericObservationForm
...
class SOARAForm(GenericObservationForm):
    pass


class SOARFacility(GenericObservationFacility):
    name = 'SOAR'
